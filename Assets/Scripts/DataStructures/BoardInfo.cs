...
{
    public class BoardInfo : ICloneable //BoardInfo implementa la interfaz Cloneable
    {
        public BoardInfo(int columns, int rows, BoardManager manager) //constructor
        {
        ...
        private BoardManager manager;               //atributo de la clase
        public int NumColumns { get; private set; } //atributo de la clase
        public int NumRows { get; private set; }    //atributo de la clase
        public CellInfo[,] CellInfos { get; set; }  //atributo de la clase

        public List<GameObject> Enemies { get; set; }   //array que contiene los enemigos
